 ...
 * Generated from actual data exploration
 */
...
export interface WardrobeItem extends Item {
  // Can extend with wardrobe-specific fields if needed
}
...
export interface AIResource {
  _id?: string;
  // Add fields based on actual data when available
  createdAt?: Date;
  updatedAt?: Date;
}
...
export const COLLECTION_DOMAIN_MAP: Record<CollectionName, CollectionDomain> = {
  'gym-progress': 'Fitness',
  'exercise-entries': 'Fitness',
  'books': 'Learning',
  'udemycourses': 'Learning',
  ...
  'streamingapps': 'Tech',
  'socialplatforms': 'Tech',
  'airesources': 'Tech',
  'modelusages': 'Tech',
  'usagelimits': 'Tech',
  'companies': 'General',
  'users': 'General',
  '10xiitian_Resources': 'General',
};

// ============================================================================
// UNION TYPE FOR ALL COLLECTIONS
// ============================================================================

export type AnyCollectionDocument =
  | GymProgress
  | Book
  | UdemyCourse
  | TleLevel3Course
